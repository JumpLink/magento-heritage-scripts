 ...
 */
var stock_csv_file = '"sku","sku_clean","_type","_attribute_set","_store","stock_vwheritage_availabilitymessagecode","stock_vwheritage_dueweeks","stock_vwheritage_qty","stock_strichweg_qty","qty","is_in_stock","vwheritage_price_pound","manufacturer","special_order"\r\n';
...
import_heritage_data_in_parts(function() {
	...
	.on('record', function(row,index){
		...
		if(i >= 0) {
			...
			var new_line = '"'+sku+'","'+sku_clean+'","'+_type+'","'+_attribute_set+'","'+_store+'","'+stock_vwheritage_availabilitymessagecode+'","'+stock_vwheritage_dueweeks+'","'+stock_vwheritage_qty+'","'+stock_strichweg_qty+'","'+qty+'","'+is_in_stock+'","'+vwheritage_price_pound+'","'+manufacturer+'","'+special_order+'"\r\n';
